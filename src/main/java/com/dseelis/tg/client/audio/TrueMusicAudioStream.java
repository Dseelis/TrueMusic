...
public class TrueMusicAudioStream implements AudioStream {
    ...
    public TrueMusicAudioStream(Path oggFile) throws IOException {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            TrueMusic.debugLog("Loaded OGG: {} channels, {}Hz, {} samples",
